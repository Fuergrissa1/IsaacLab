...
"""Configuration for the Tilt-Rotor 2D Experiment."""
TILTROTOR_CFG = ArticulationCfg(
    prim_path="{ENV_REGEX_NS}/Robot",
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"C:/Users/cdlapoin/Documents/TR_RL/RL_Tiltrotor.usd/RL_Tiltrotor_Scene.usd",
